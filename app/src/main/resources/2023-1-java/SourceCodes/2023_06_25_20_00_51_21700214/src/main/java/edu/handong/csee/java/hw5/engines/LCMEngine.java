...
/**
 * the class contains fields,methods that implements Computable interface for calculating least common multiple.
 * @author kim hongchan
 *
 */
public class LCMEngine implements Computable{
	/**
	 * String value that means engine name initialized as "LCM"
	 */
