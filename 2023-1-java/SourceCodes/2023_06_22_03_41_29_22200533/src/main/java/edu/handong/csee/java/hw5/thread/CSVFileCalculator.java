...
public class CSVFileCalculator implements Runnable {
	 ...
	 * constructor 
	 */
    public CSVFileCalculator(String filePath, String fileName, OptionHandler optionHandler, Options options, String engineName) {
        this.filePath = filePath;
        this.optionHandler = optionHandler;
        this.options = options;
        this.engineName = engineName;
    ...
    public void run() {
    	...
    	if( (engineName.equals("MAX") || engineName.equals("SQRT") || engineName.equals("MIN") ) && optionHandler.getInputValues() == null) {
        	...
        	if(engineName.equals("SQRT") && optionHandler.getDatalnputFilePath() != null) {
            	...
            	//System.out.println(fileName + n+ row_n);
            	if(row_n == 1) {
            		
            		if(n == 0) {
            			System.out.println("Exception-04: You need one input value for SQRT.");
            			//System.exit(0);
            		...
            		//System.out.println(fileName + row_n + n);
            	...
            	if(row_n < 1) {
            		//System.out.println(fileName + row_n + n);
            		if(n == 1) {
            			System.out.println("Exception-02: You need at least 2 input values for MAX.");
            		}
