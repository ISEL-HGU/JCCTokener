...
/**
 * A calculator that finds the minimum value among two or more numbers.
 */
public class MinEngine implements Computable {
    ...
    /**
     * Sets numbers to calculate min number.
     * 
     * @param inputs numbers to calculate min number
     */
    ...
    /**
     * Gets numbers to calculate min number.
     * 
     * @return numbers to calculate min number
     */
    ...
    /**
     * Sets a result of calculating the min number.
     * 
     * @param result a value of calculating the min number
     */
    ...
    /**
     * Calculates the smallest value among the numbers.
     */
    public void compute(){
        result = inputs[0];
